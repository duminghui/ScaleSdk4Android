...
public class ModXListView extends ListView
  implements AbsListView.OnScrollListener
{
  ...
  private ModXListViewFooter mFooterView;
  private TextView mHeaderTimeView;
  private ModXListViewHeader mHeaderView;
  ...
  public ModXListView(Context paramContext)
  {
    super(paramContext);
    initWithContext(paramContext);
  }

  public ModXListView(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    initWithContext(paramContext);
  }

  public ModXListView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  private void initWithContext(Context paramContext)
  {
    ...
    this.mHeaderView = new ModXListViewHeader(paramContext);
    this.mHeaderViewContent = ((RelativeLayout)this.mHeaderView.findViewById(2131100750));
    this.mHeaderTimeView = ((TextView)this.mHeaderView.findViewById(2131100753));
    addHeaderView(this.mHeaderView);
    this.mFooterView = new ModXListViewFooter(paramContext);
    this.mHeaderView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener()
    {
      public void onGlobalLayout()
      {
        ModXListView.this.mHeaderViewHeight = ModXListView.this.mHeaderViewContent.getHeight();
        ModXListView.this.getViewTreeObserver().removeGlobalOnLayoutListener(this);
      }
    });
  }
  ...
  public void setPullLoadEnable(boolean paramBoolean)
  {
    ...
    this.mFooterView.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        ModXListView.this.startLoadMore();
      }
    });
  }
