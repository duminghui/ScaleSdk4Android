...
public class HorzhiLine_Translucent2 extends View
{
  private float endX;
  private float endY;
  private Rect mRect;
  ...
  public HorzhiLine_Translucent2(Context paramContext, AttributeSet paramAttributeSet)
  {
 ...
 * Qualified Name:     HorzhiLine_Translucent2
