...
public abstract class PicoocAbstractChart
  implements IPicoocChart
{
  ...
  protected MultipleCategorySeries buildMultipleCategoryDataset(String paramString, List<String[]> paramList, List<double[]> paramList1)
  {
    ...
    while (true)
    {
      ...
      localMultipleCategorySeries.add(i + 2007, (String[])paramList.get(i), arrayOfDouble);
      i++;
    }
  }
  ...
  protected void setChartSettings(XYMultipleSeriesRenderer paramXYMultipleSeriesRenderer, String paramString1, String paramString2, String paramString3, double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, int paramInt1, int paramInt2)
  {
 ...
 * Qualified Name:     PicoocAbstractChart
