  ...
  implements PageIndicator
{
  ...
  public LinePageIndicator(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    int i = localResources.getColor(2131165253);
    int j = localResources.getColor(2131165254);
    float f1 = localResources.getDimension(2131230886);
    float f2 = localResources.getDimension(2131230887);
    float f3 = localResources.getDimension(2131230888);
    boolean bool = localResources.getBoolean(2131492866);
    ...
    this.mLineWidth = localTypedArray.getDimension(5, f1);
    this.mGapWidth = localTypedArray.getDimension(6, f2);
    setStrokeWidth(localTypedArray.getDimension(3, f3));
    this.mPaintUnselected.setColor(localTypedArray.getColor(4, j));
    this.mPaintSelected.setColor(localTypedArray.getColor(2, i));
  ...
  private int measureWidth(int paramInt)
  {
    ...
    {
      return (int)FloatMath.ceil(f);
      int k = this.mViewPager.getAdapter().getCount();
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    label204: for (Paint localPaint = this.mPaintSelected; ; localPaint = this.mPaintUnselected)
    {
 ...
 * Qualified Name:     LinePageIndicator
