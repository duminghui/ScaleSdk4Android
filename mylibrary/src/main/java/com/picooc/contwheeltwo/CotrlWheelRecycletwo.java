...
public class CotrlWheelRecycletwo
{
  private List<View> emptyItems;
  private List<View> items;
  private CotrlWheelViewTwo wheel;

  public CotrlWheelRecycletwo(CotrlWheelViewTwo paramCotrlWheelViewTwo)
  {
    this.wheel = paramCotrlWheelViewTwo;
  }
 ...
 * Qualified Name:     CotrlWheelRecycletwo
