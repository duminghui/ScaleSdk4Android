...
public class LatinSeasonData
{
  ...
  public LatinSeasonData(int paramInt, RoleBin paramRoleBin, Context paramContext)
  {
    if (paramRoleBin.getAge() > 60)
      paramRoleBin.setGoal_fat(-1.0F);
    this.seasonFlag = paramInt;
    long[] arrayOfLong = DateUtils.getSeasonStartTimeAndTimeAndDays(paramInt);
    this.seasonStartTime = arrayOfLong[0];
    this.seasonEndTime = arrayOfLong[1];
    this.days = ((int)arrayOfLong[2]);
    String[] arrayOfString = new String[3];
    arrayOfString[0] = ((int)arrayOfLong[3] + "月");
    arrayOfString[1] = ((int)arrayOfLong[4] + "月");
    arrayOfString[2] = ((int)arrayOfLong[5] + "月");
    this.xLableStr = arrayOfString;
    ...
    if (i >= j)
      if (paramInt != 0)
        break label354;
    label354: for (this.weekBodys = OperationDB.selectBodyIndexBetweenStartTimeAndEndTimeAndRoleID(paramContext, this.seasonStartTime, DateUtils.getDayStartTimeAndEndTimeByFlag(0)[1], paramRoleBin.getRole_id()); ; this.weekBodys = OperationDB.selectBodyIndexBetweenStartTimeAndEndTimeAndRoleID(paramContext, this.seasonStartTime, this.seasonEndTime, paramRoleBin.getRole_id()))
    {
    ...
    label377: BodyIndex localBodyIndex1 = BodyIndex.getAvgValueByArrayList(OperationDB.selectDayValuesBeforeTimestampAndRid(paramContext, this.seasonStartTime, paramRoleBin.getRole_id()));
    label427: int k;
    long l;
    float f1;
    float f2;
    ...
    if (localBodyIndex1 == null)
    {
      ...
      k = (int)((((BodyIndex)this.weekBodys.get(0)).getTime() - this.seasonStartTime) / 86400000L);
      l = (System.currentTimeMillis() - this.seasonStartTime) / 86400000L;
      f1 = 0.0F;
      f2 = 0.0F;
      f3 = 0.0F;
      f4 = 0.0F;
      ...
      i3 = 0;
      label534: int i4 = this.weightArray.length;
      if (i3 < i4)
        break label1200;
      ...
      if (this.weekBodys.size() > 0)
      {
        ...
        label634: if (paramRoleBin.getGoal_fat() <= 0.0F)
          break label1243;
    ...
    while (true)
    {
      ...
      break;
      label697: ArrayList localArrayList = OperationDB.selectDayValuesAfterTimestampAndRid(paramContext, this.seasonEndTime, paramRoleBin.getRole_id());
      ...
      this.nextMonthFirstBodyfat = -1.0F;
      break label427;
      label767: BodyIndex localBodyIndex2 = (BodyIndex)this.weekBodys.get(m);
      int i1 = (int)((localBodyIndex2.getTime() - this.seasonStartTime) / 86400000L);
      if (k != i1)
      {
        float f11 = f1 / f4;
        f6 = f11;
        ...
        {
          f5 = 1.0F;
          label884: f1 = localBodyIndex2.getWeight();
          f2 = localBodyIndex2.getBodyFat();
          f3 = localBodyIndex2.getBmi();
          f4 = 1.0F;
          label908: int i2 = -1 + this.weekBodys.size();
          if (m == i2)
          {
            if (l != i1)
              break label1069;
      ...
      this.monthBodyFatChange = 0.0F;
      break label526;
      label1200: if (this.weightArray[i3] > 0.0D)
        this.monthWeightingNum = (1 + this.monthWeightingNum);
      i3++;
      break label534;
      label1228: this.goalWeightArray[(-1 + this.days)] = 1.0D;
      break label634;
      label1243: this.goalFatArray[0] = paramRoleBin.getGoal_fat();
    }
  }
  ...
  {
    int i = (int)DateUtils.getHowManyDaysBetweenNewTimeStampAndOldTimeStamp(paramBodyIndex.getTime(), this.seasonStartTime);
    if (i > -1 + this.days)
      i = -1 + this.days;
 ...
 * Qualified Name:     LatinSeasonData
