...
public class CotrlWheelViewheight extends View
{
  ...
  private DataSetObserver dataObserver = new DataSetObserver()
  {
    ...
    {
      CotrlWheelViewheight.this.invalidateWheel(false);
    }

    public void onInvalidated()
    {
      CotrlWheelViewheight.this.invalidateWheel(true);
    }
  };
  ...
  Context mContext;
  private CotrlWheelRecycleheight recycle = new CotrlWheelRecycleheight(this);
  private CotrlWheelScroller scroller;
  ScrollingListener scrollingListener = new ScrollingListener()
  {
    public void onFinished()
    {
      if (CotrlWheelViewheight.this.isScrollingPerformed)
      {
        CotrlWheelViewheight.this.notifyScrollingListenersAboutEnd();
        CotrlWheelViewheight.this.isScrollingPerformed = false;
      }
      CotrlWheelViewheight.this.scrollingOffset = 0;
      CotrlWheelViewheight.this.invalidate();
    }

    public void onJustify()
    {
      if (Math.abs(CotrlWheelViewheight.this.scrollingOffset) > 1)
        CotrlWheelViewheight.this.scroller.scroll(CotrlWheelViewheight.this.scrollingOffset, 0);
    }

    public void onScroll(int paramAnonymousInt)
    {
      CotrlWheelViewheight.this.doScroll(paramAnonymousInt);
      if (CotrlWheelViewheight.this.scrollingOffset > 50)
      {
        CotrlWheelViewheight.this.scrollingOffset = 50;
        CotrlWheelViewheight.this.scroller.stopScrolling();
      }
      while (CotrlWheelViewheight.this.scrollingOffset >= -50)
        return;
      CotrlWheelViewheight.this.scrollingOffset = (-50);
      CotrlWheelViewheight.this.scroller.stopScrolling();
    }
    ...
    {
      CotrlWheelViewheight.this.isScrollingPerformed = true;
      CotrlWheelViewheight.this.notifyScrollingListenersAboutStart();
    }
  };
  ...
  public CotrlWheelViewheight(Context paramContext)
  {
    super(paramContext);
  ...
  public CotrlWheelViewheight(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public CotrlWheelViewheight(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  private void drawCenterRect(Canvas paramCanvas)
  {
    ...
    localPaint.setTypeface(ModUtils.getTypeface(this.mContext));
    if (key == 2)
      paramCanvas.drawText("kg", i + j * 5, i + 11, localPaint);
    while (true)
    {
      this.centerDrawable.draw(paramCanvas);
      return;
      paramCanvas.drawText("CM", i + j * 5, i + 11, localPaint);
    }
  }
  ...
  private void initResourcesIfNecessary()
  {
    if (this.centerDrawable == null)
      this.centerDrawable = getContext().getResources().getDrawable(2130838677);
 ...
 * Qualified Name:     CotrlWheelViewheight
