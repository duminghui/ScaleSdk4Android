...
public class CotrlWheelRecycleheight
{
  private List<View> emptyItems;
  private List<View> items;
  private CotrlWheelViewheight wheel;

  public CotrlWheelRecycleheight(CotrlWheelViewheight paramCotrlWheelViewheight)
  {
    this.wheel = paramCotrlWheelViewheight;
  }
 ...
 * Qualified Name:     CotrlWheelRecycleheight
