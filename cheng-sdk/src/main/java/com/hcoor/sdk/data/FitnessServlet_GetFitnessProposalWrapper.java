 ...
 */
public class FitnessServlet_GetFitnessProposalWrapper extends BaseNetRequestWrapper {
    private static final String PARAMS_KEY_MEMBERID = "memberId";
    private static final String PARAMS_KEY_ACCOUNTID = "accountId";

    protected FitnessServlet_GetFitnessProposalWrapper(RequestQueue requestQueue, NetRequestListener listener) {
