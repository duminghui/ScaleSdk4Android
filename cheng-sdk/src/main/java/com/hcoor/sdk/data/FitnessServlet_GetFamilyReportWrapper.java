 ...
 */
public class FitnessServlet_GetFamilyReportWrapper extends BaseNetRequestWrapper {
    private static final String PARAMS_KEY_ACCOUNTID = "accountId";

    protected FitnessServlet_GetFamilyReportWrapper(RequestQueue requestQueue, NetRequestListener listener) {
